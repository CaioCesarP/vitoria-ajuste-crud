...
async function editProduct(id) {
  ...
  form.innerHTML = `
    <h2>Edit Product</h2>
    <input type="text" id="name-input" placeholder="Name" value="${product.name}" required />
    <input type="text" id="description-input" placeholder="Description" value="${product.description}" required />
    <input type="number" id="price-input" placeholder="Price" value="${product.price}" required />
